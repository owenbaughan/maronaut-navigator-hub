...
import { MapPin, Clock, Compass, Wind, Anchor, Share2, Calendar, Activity, Star, Bookmark, Award, Ship, Users, User, UserPlus } from 'lucide-react';
                ...
                <Tabs defaultValue="dashboard" value={activeTab} onValueChange={setActiveTab} className="w-full animate-fade-in">
                  ...
                  <TabsContent value="friends" className="space-y-8">
                    <div className="glass-panel p-6 animate-fade-in mb-8">
                      <div className="flex items-center justify-between mb-4">
                        <h2 className="text-xl font-semibold text-maronaut-700 flex items-center">
