...
const Profile = () => {
  ...
  const loadProfileData = async () => {
    ...
    try {
      setIsLoading(true);
      console.log("Loading profile data on profile page for:", currentUser.uid);
      ...
      console.log("Profile loaded on profile page:", profile);
      
      if (profile) {
        setFirstName(profile.firstName || parsedFirstName);
        setLastName(profile.lastName || parsedLastName);
        setBio(profile.bio || "");
